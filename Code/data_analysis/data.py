...
df["time_sec"] = df["hour"]*3600 + df["minute"]*60 + df["second"]
df["time_sec"] = df["time_sec"] / 60
df.plot(x="time_sec", y="BlackGlobetemp", ax=ax, label="B2 Globe Temperature", color="green")
...
df["time_sec"] = df["hour"]*3600 + df["minute"]*60 + df["second"]
df["time_sec"] = df["time_sec"] / 60
df.plot(x="time_sec", y="BlackGlobetemp", ax=ax, label="BP Globe Temperature", color="blue")
...
df["time_sec"] = df["hour"]*3600 + df["minute"]*60 + df["second"]
df["time_sec"] = df["time_sec"] / 60
df.plot(x="time_sec", y="BlackGlobetemp", ax=ax, label="S1 Globe Temperature", color="black")
...
df["time_sec"] = df["hour"]*3600 + df["minute"]*60 + df["second"]
df["time_sec"] = df["time_sec"] / 60
df.plot(x="time_sec", y="BlackGlobetemp", ax=ax, label="S2 Globe Temperature", color="purple")
