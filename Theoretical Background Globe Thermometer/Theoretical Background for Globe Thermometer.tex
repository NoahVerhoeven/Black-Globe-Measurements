...
\begin{figure}[H]
	...
	\caption{Recovered true MRT based on the inverse moving average matrix. We used a linear decay (right weighted) moving average with an optimal window size of 137, this was found based on 1000 simulated data points.}
